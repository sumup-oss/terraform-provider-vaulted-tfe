...
1. Specify `provider` by following https://github.com/sumup-oss/terraform-provider-vaultedtfe/blob/master/USAGE.md#provider
1. Add `vaultedtfe_variable` resources
1. `terraform plan`
1. `terraform apply`
1. :tada:
...
Create a new resource using [vaulted terraform tfe new-resource]. E.g
